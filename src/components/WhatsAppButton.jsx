...
import { getWhatsAppUrl, getWhatsAppMessage } from '../config/whatsapp';

const WhatsAppButton = ({ currentService = null }) => {
  const { t } = useTranslations();
  const [isHovered, setIsHovered] = useState(false);

  const handleWhatsAppClick = () => {
    // Obtener mensaje personalizado según el servicio actual
    const message = getWhatsAppMessage(currentService);
