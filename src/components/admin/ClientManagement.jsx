...
const ClientManagement = () => {
  ...
  const filteredClients = clients.filter(client => {
    ...
    const matchesIndustry = filterIndustry === 'todos' || client.industry === filterIndustry;
  ...
  return (
    <div className="min-h-screen relative z-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Clients Table */}
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 overflow-hidden relative z-0">
              ...
              <tbody className="divide-y divide-white/10">
                {filteredClients.map((client) => (
                  <tr key={client.id} className="hover:bg-white/5 transition-colors duration-200">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${statusColors[client.status] || 'bg-gray-500'} text-white`}>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-300">{client.lastContact || 'Sin contacto'}</td>
                    <td className="px-6 py-4">
