...
const GoogleLoginButton = ({ onSuccess, onError, buttonText = "Continuar con Google", className = "" }) => {
  const login = useGoogleLogin({
    onSuccess: (tokenResponse) => {
      console.log('🟢 Google OAuth: Token response received:', tokenResponse);
  ...
  const handleGoogleSuccess = async (tokenResponse) => {
    try {
      ...
      // Preparar datos del usuario para nuestro sistema
      const userData = {
