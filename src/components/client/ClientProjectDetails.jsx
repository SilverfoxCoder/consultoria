        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 mb-6">
              <div className="flex space-x-1 p-1">
                {[
                  ...
                  { id: 'progress', name: 'Progreso', icon: ChartBarIcon },
                  { id: 'timeline', name: 'Cronograma', icon: CalendarIcon },
                  { id: 'budget', name: 'Presupuesto', icon: CurrencyEuroIcon },
                  { id: 'support', name: 'Soporte', icon: ChatBubbleLeftRightIcon }
                ].map((tab) => (
                  <button
                    key={tab.id}
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
              ...
              {activeTab === 'progress' && (
                <div>
                  <h3 className="text-xl font-semibold text-white mb-6">Progreso del Proyecto</h3>
                  <div className="text-center py-12 text-gray-400">
                    <ChartBarIcon className="h-12 w-12 mx-auto mb-4" />
                    <p>Información de progreso no disponible</p>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'budget' && (
                <div>
                  <h3 className="text-xl font-semibold text-white mb-6">Información de Presupuesto</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {activeTab === 'support' && (
                <div>
                  <h3 className="text-xl font-semibold text-white mb-6">Soporte y Comunicación</h3>
                  <div className="space-y-6">
                    <div className="bg-gray-700/30 rounded-lg p-6">
                      <h4 className="text-lg font-semibold text-white mb-4">Contacto de Soporte</h4>
                      <div className="space-y-3">
                        <div>
                    ...
                    <div className="bg-gray-700/30 rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <button className="flex items-center space-x-3 p-4 bg-blue-600/20 hover:bg-blue-600/30 rounded-lg text-blue-400 transition-colors duration-200">
                          <ChatBubbleLeftRightIcon className="h-5 w-5" />
                          <span>Crear Ticket de Soporte</span>
                        </button>
                        <button className="flex items-center space-x-3 p-4 bg-green-600/20 hover:bg-green-600/30 rounded-lg text-green-400 transition-colors duration-200">
                          <PlusIcon className="h-5 w-5" />
                          <span>Solicitar Cambios</span>
                        </button>
                      </div>
