    ...
    const loadAnalytics = async () => {
      ...
      try {
        ...
        if (hasBackendData) {
          ...
          const serviceBreakdownMock = [
            { service: 'Desarrollo Web', percentage: 40, amount: 6000 },
            { service: 'Aplicaciones Móviles', percentage: 35, amount: 5250 },
            { service: 'Consultoría IT', percentage: 25, amount: 3750 }
          ];
          ...
          setProjectPerformance(projectPerformanceMock);
          setServiceBreakdown(serviceBreakdownMock);
